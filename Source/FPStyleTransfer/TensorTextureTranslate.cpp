...
IMPLEMENT_GLOBAL_SHADER(FTensor2TextureCS, "/ProjectShaders/Shaders/tensor2Texture.usf", "tensorToImage", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FTexture2TensorCS, "/ProjectShaders/Shaders/texture2Tensor.usf", "imageToTensor", SF_Compute);
